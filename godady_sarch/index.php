...
<html lang="en">
    <head>
        <!--=============== basic  ===============-->
        <meta charset="UTF-8">
        <title>Pelazri  - Creative  Architecture Interior  Portfolio Template</title>
        ...
        <div id="main">
            ...
            <header class="main-header">
                ...
                <div class="header_social ">
                    <ul >
                        <li><a href="https://www.facebook.com/sarchliving" target="_blank">Fb</a></li>
                        <li><a href="#" target="_blank">Tw</a></li>
                        <li><a href="https://www.instagram.com/sarchliving/" target="_blank">In</a></li>
            ...
            <div class="top-header top-header-half">
                ...
                <a href="contacts.html" class="single-page-fixed-row-link ajax"><i class="fal fa-envelope"></i> <span>Get In Touch</span></a>           
            </div>
            <!-- top-header  end-->     
            <!-- wrapper  -->   
            <div id="wrapper">
                ...
                <div class="content-holder" data-pagetitle="Home Slider">
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="index3.html" class="ajax">Video</a></li>
                                      ...
                                      <!--  <li>
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="portfolio4.html" class="ajax">Boxed Grid</a></li>
                                                <li><a href="portfolio5.html" class="ajax">Column Filter</a></li>
                                                <li> -->
                                                    <a href="#">Single</a>
                                                    <!--level 3 -->
                                                    <ul>
                                       ...
                                       <!-- <li><a href="blog.html" class="ajax">Blog</a></li> 
                                        <li>
                                            ...
                                            <!--level 2 
                                            <ul>
                                                <li><a href="team-single.html" class="ajax">Team Single</a></li>
                                                <li><a href="services-single.html" class="ajax">Services Single</a></li>
                    ...
                    <div class="hero-wrap fl-wrap full-height scroll-con-sec" id="sec0">
                                ...
                                <div class="swiper-container  ">
                                    <div class="swiper-wrapper" >
                                        ...
                                        <div class="swiper-slide"  >
                                            <div class="fs-slider-item fl-wrap">
                                                <div class="fs-slider_align_title">
                                                    ...
                                                    <h2><a href="#sec1" class="custom-scroll-link">Pelzari     Architecture<br>Design <span> Agency</span></a></h2>
                                                    <p  >Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas in pulvinar neque. Nulla finibus lobortis pulvinar. </p>
                                                    <div class="clearfix"></div>
                                                    <a href="#sec1" class="hero_btn custom-scroll-link">Read More About Us</a>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- swiper-slide-->
                                        ...
                                        <div class="swiper-slide hov_zoom"  >
                                            <div class="fs-slider-item fl-wrap">
                                                <div class="fs-slider_align_title">
                                                    <div class="hhw_header">25.05.2020</div>
                                                    <h2><a href="portfolio-single.html" class="ajax">Trinity River <br> <span>Audubon</span> Centre</a></h2>
                                                    <p  >Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas in pulvinar neque. Nulla finibus lobortis pulvinar. </p>
                                                    <div class="clearfix"></div>
                                                    <a href="portfolio-single.html" class="hero_btn ajax">View Details</a>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- swiper-slide-->
                                        ...
                                        <div class="swiper-slide hov_zoom"  >
                                            <div class="fs-slider-item fl-wrap">
                                                <div class="fs-slider_align_title">
                                                    <div class="hhw_header">11.04.2020</div>
                                                    <h2><a href="portfolio-single.html" class="ajax">Private <span>House</span> in <br> London UK</a></h2>
                                                    <p  >Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas in pulvinar neque. Nulla finibus lobortis pulvinar. </p>
                                                    <div class="clearfix"></div>
                                                    <a href="portfolio-single.html" class="hero_btn ajax">View Details</a>
                                                </div>
                                        ...
                                        <div class="swiper-slide hov_zoom"  >
                                            <div class="fs-slider-item fl-wrap">
                                                <div class="fs-slider_align_title">
                                                    <div class="hhw_header">14.02.2021</div>
                                                    <h2><a href="portfolio-single.html" class="ajax">One World <br>Trade <span>Center</span></a></h2>
                                                    <p  >Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas in pulvinar neque. Nulla finibus lobortis pulvinar. </p>
                                                    <div class="clearfix"></div>
                                                    <a href="portfolio-single.html" class="hero_btn ajax">View Details</a>
                                                </div>
                            ...
                            <div class="hero-slider-img hidden-item">
                                <div class="swiper-container">
                                    <div class="swiper-wrapper" >
                                        ...
                                        <!-- swiper-slide-->
                                        <div class="swiper-slide">
                                            <div class="bg"  data-bg="images/bg/5.jpg" data-swiper-parallax="20%"></div>
                                            <div class="overlay"></div>
                                        </div>
                                        <!-- swiper-slide end-->
                                        <!-- swiper-slide-->
                                        <div class="swiper-slide">
                                            <div class="bg"  data-bg="images/bg/17.jpg" data-swiper-parallax="20%"></div>
                                            <div class="overlay"></div>
                                        </div>
                                        <!-- swiper-slide end-->
                                        <!-- swiper-slide-->
                        ...
                        <a href="#sec1" class="custom-scroll-link start-btn"><span> Start explore  </span><i class="fal fa-long-arrow-down"></i></a>                        
                    </div>
                    <!-- hero-wrap  end--> 
                    <!-- content-->
                    <div class="content">
                        ...
                        <div class="column-wrap">
                            ...
                            <div class="column-wrap-container white-bg fl-wrap">
                                ...
                                <section id="sec1" class="scroll-con-sec">
                                    <div class="container">
                                        <div class="section-title fl-wrap">
                                            <h2>About Our   <strong> Agency</strong></h2>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas in pulvinar neque. Nulla finibus lobortis pulvinar.  </p>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="text-block fl-wrap">
                                                    <h4 class="text-block_subtitle">Award Winning Architecture<br> Design Agency</h4>
                                                    ...
                                                    <p>Our team takes over everything, from an idea and concept development to realization. We believe in traditions and incorporate them within our innovations. All our projects incorporate a unique artistic image and functional solutions. .</p>
                                                    ...
                                                    <a href="#sec2" class="btn float-btn custom-scroll-link">Our Works</a>
                                                </div>
                                            </div>
                                        </div>
                               ...
                               <section class="dark-bg sec-car scroll-con-sec" id="sec2">
                                    <div class="fet_pr-carousel_title fl-wrap">
                                        <div class="container">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <a href="portfolio.html" class="ajax   fet_pr-carousel_link btn">View all Cases</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <!-- <div class="swiper-slide"> 
                                                        <div class="fet_pr-carousel-box">
                                                            <div class="fet_pr-carousel-box-media fl-wrap">
                                                                <div class="bg par-elem"  data-bg="images/folio/9.jpg" data-swiper-parallax="10%"></div>
                                                                <div class="overlay"></div>
                                                                <div class="grid-det_category"><a href="#">Interior</a> <a href="#">Houses</a></div>
                                                                <div class="grid-det_num">01.</div>
                                                            </div>
                                                            <div class="fet_pr-carousel-box-text fl-wrap">
                                                                <a href="portfolio-single.html" class="ajax">Wood River Ships Center</a> 
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="swiper-slide">
                                                        <div class="fet_pr-carousel-box">
                                                         <!--   <div class="fet_pr-carousel-box-media fl-wrap"> 
                                                                <div class="bg par-elem"  data-bg="images/folio/2.jpg" data-swiper-parallax="10%"></div>
                                                                <div class="overlay"></div> 
                                                                <div class="grid-det_category"><a href="#">Architecture</a> <a href="#">Houses</a></div>
                                                                <div class="grid-det_num">02.</div> 
                                                            </div>
                                                          <!--  <div class="fet_pr-carousel-box-text fl-wrap">
                                                                <a href="portfolio-single.html" class="ajax">Theatre de Stoep </a> 
                                                            </div>
                                                        </div> 
                                                    </div> -->
                                                    <!-- fet_pr-carousel-box end -->
                                                   ...
                                                   <!-- <div class="swiper-slide">
                                                        <div class="fet_pr-carousel-box">
                                                            <div class="fet_pr-carousel-box-media fl-wrap">
                                                                <div class="bg par-elem"  data-bg="images/folio/11.jpg" data-swiper-parallax="10%"></div>
                                                                <div class="overlay"></div>
                                                                <div class="grid-det_category"><a href="#">Architecture</a> <a href="#">Interior</a></div>
                                                                <div class="grid-det_num">03.</div>
                                                            </div>
                                                            <div class="fet_pr-carousel-box-text fl-wrap">
                                                                <a href="portfolio-single.html" class="ajax">White Walls Hotel</a> 
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- fet_pr-carousel-box end -->  
                                                  ...
                                                  <!-- <div class="swiper-slide"> -
                                                        <div class="fet_pr-carousel-box">
                                                            <div class="fet_pr-carousel-box-media fl-wrap">
                                                                <div class="bg par-elem"  data-bg="images/folio/8.jpg" data-swiper-parallax="10%"></div>
                                                                <div class="overlay"></div>
                                                                <div class="grid-det_category"><a href="#">Architecture</a> <a href="#">Houses</a></div>
                                                                <div class="grid-det_num">04.</div>
                                                            </div>
                                                            <div class="fet_pr-carousel-box-text fl-wrap">
                                                                <a href="portfolio-single.html" class="ajax">Private House in London</a> 
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- fet_pr-carousel-box end -->                                                    
                                ...
                                <section class="scroll-con-sec gray-bg" id="sec3">
                                    <div class="container">
                                        <div class="section-title fl-wrap">
                                            <h2>Services  <strong>  Provided</strong></h2>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas in pulvinar neque. Nulla finibus lobortis pulvinar.  </p>
                                            <div class="sec-title_dec"></div>
                                        </div>
                                        <div class="column-wrapper_text fl-wrap">
                                            ...
                                            <div class="serv-wrap fl-wrap">
                                                ...
                                                <div class="serv-item">
                                                    ...
                                                    <div class="serv-text">
                                                        <h4><a href="services-single.html" class="ajax">Architecture</a></h4>
                                                        ...
                                                        <a href="services-single.html" class="serv-link ajax">View Details</a>
                                                    </div>
                                                </div>
                                                <!-- serv-item end -->
                                                <!-- serv-item -->
                                                <div class="serv-item serv-item-right">
                                                    ...
                                                    <div class="serv-text">
                                                        <h4><a href="services-single.html" class="ajax">Interior</a></h4>
                                                        <p> Sed blandit, dolor id aliquam vestibulum, nibh elit imperdiet turpis, quis molestie quam erat vel nisi.</p>
                                                        <ul>
                                                            <li>Concept</li>
                                                            <li>Design</li>
                                                ...
                                                <div class="serv-item ">
                                                    ...
                                                    <div class="serv-text">
                                                        <h4><a href="services-single.html" class="ajax">Commercial</a></h4>
                                                        <p> Sed blandit, dolor id aliquam vestibulum, nibh elit imperdiet turpis, quis molestie quam erat vel nisi.</p>
                                                        <ul>
                                                            <li>Concept</li>
                                                            <li>Design</li>
                                            ...
                                            <a href="contacts.html" class="btn float-btn ajax  "><span>Get In Touch</span></a>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="video-promo-text fl-wrap mar-top">
                                                    <h3>Our Video   <strong>Presentation</strong></h3>
                                                    ...
                                                    <a href="#" class="btn float-btn   "><span>Our Youtube Chanel</span></a>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="video-box dec-img fl-wrap">
                                                    <img src="images/folio/18.jpg" alt="" class="respimg">
                            ...
                            <!---->    <section class="scroll-con-sec" id="sec4">
                                    <div class="container">
                                     <!--   <div class="section-title fl-wrap">
                                            <h2>Our Awesome <strong>Team</strong></h2>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas in pulvinar neque. Nulla finibus lobortis pulvinar.  </p>
                                            <div class="sec-title_dec"></div>
                                        </div> -->
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="team-box">
                                                    <div class="team-photo">
                                                        ...
                                                        <div class="team-info-num">01.</div>
                                                        <a href="team-single.html" class="team-link ajax">View Details</a>
                                                    </div>
                                                 <!--   <div class="team-info">
                                                        <h3><a href="team-single.html" class="ajax">David Gray</a></h3>
                                                        <h4>CEO / Architect</h4>
                                            ...
                                            <div class="col-md-6">
                                                <div class="team-box">
                                                    ...
                                                    <div class="team-info">
                                                        <h3><a href="team-single.html" class="ajax">Alica Limishko</a></h3>
                                            ...
                                            <div class="col-md-6">
                                                <div class="team-box">
                                                    ...
                                                    <div class="team-info">
                                                        <h3><a href="team-single.html" class="ajax">Olivia Edminton</a></h3>
                                                        <h4>Architect / Designer</h4>
                                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.  </p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="team-box">
                                                    ...
                                                    <div class="team-info">
                                                        <h3><a href="team-single.html" class="ajax">Kevin Brunt</a></h3>
                                                        <h4>Architect / Designer</h4>
                                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.  </p>
                                                    </div>
                                                </div>
                                ...
                                <section class="scroll-con-sec gray-bg " id="sec5">
                                    <div class="container">
                                        <div class="section-title fl-wrap">
                                            <h2>Clents <strong> And Testimonilas</strong></h2>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas in pulvinar neque. Nulla finibus lobortis pulvinar.  </p>
                                            <div class="sec-title_dec"></div>
                                        </div>
                                    ...
                                    <div class="page-scroll-nav fl-wrap">
                                        <nav class="scroll-init color2-bg">
                                            <ul class="no-list-style">
                                                <li><a class="scroll-link fbgs actscr-link" href="#sec1" data-bgscr="images/bg/long/5.jpg" data-bgtex="01. About Us"><span>About</span></a></li>
                                                <li><a class="scroll-link fbgs" href="#sec2" data-bgscr="images/bg/long/6.jpg" data-bgtex="02. Porfolio"><span>Cases</span></a></li>
                                                <li><a class="scroll-link fbgs" href="#sec3" data-bgscr="images/bg/long/7.jpg" data-bgtex="03. Services"><span>Services</span></a></li>
                                                <li><a class="scroll-link fbgs" href="#sec4" data-bgscr="images/bg/long/8.jpg" data-bgtex="04. Our Team"><span>Team</span></a></li>
                                                <li><a class="scroll-link fbgs" href="#sec5" data-bgscr="images/bg/long/1.jpg" data-bgtex="05. Clients"><span>Clients</span></a></li>
                                            </ul>
                                        </nav>
                                    </div>
                                    <!--page-scroll-nav end-->                          
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="footer-contacts footer-box fl-wrap">
                                            <ul>
                                                ...
                                                <li><span>LandMark: </span><a href="#"> beside Kalyan Jewellers, CBM Compound,</a></li>
                                                <li><span>City :</span><a href="#">Visakhapatnam, Andhra Pradesh 530003</a></li>
                                            </ul>   
                                            
                                        </div>
                                        <!-- footer contacts end -->
                                        <a href="contacts.html" class="ajax fc_button btn float-btn">Get In Touch</a>
                                    </div>
                                    <div class="col-md-4">
            ...
            <script>(function(w, d) { w.CollectId = "62136743615a07609d71d4c9"; var h = d.head || d.getElementsByTagName("head")[0]; var s = d.createElement("script"); s.setAttribute("type", "text/javascript"); s.async=true; s.setAttribute("src", "https://collectcdn.com/launcher.js"); h.appendChild(s); })(window, document);</script>
            <!-- wrapper end -->
            <!-- cursor-->
            <div class="element">
...
<!-- Mirrored from pelzari.kwst.net/site/contacts.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Sep 2021 10:13:04 GMT -->
</html>
